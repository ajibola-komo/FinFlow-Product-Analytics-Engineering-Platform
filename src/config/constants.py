...
IMMEDIATE_LOGINS_TIME_FRAME = [60,300]
SAME_DAY_LOGINS_TIME_FRAME = [18000,86400]
DELAYED_LOGINS_TIME_FRAME = [86400,604800]
UNACTIVATED_USERS_TIME_FRAME = [600,1209600]
WALLET_ACTIVATION_SUBSET = 0.6
IMMEDIATE_ACTIVATION_SUBSET = 0.2

IMMEDIATE_WALLET_ACTIVATION_TIME_FRAME = [600,3600]
DELAYED_WALLET_ACTIVATION_TIME_FRAME = [3600,10080]
